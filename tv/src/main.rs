...
fn sharing_resource_refcell_count() {
    ...
    //Add me
    me = FamilyMember { tv: Rc::clone(&dad.tv) };
    // and show channel you are watching
    println!("TV channel for me{:?}", me.tv);
    //show how many people are watchi ne
    println!("people are waatching {}", Rc::strong_count(&me.tv));
